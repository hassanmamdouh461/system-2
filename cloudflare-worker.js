/**
 * Cloudflare Worker Proxy for D1 Database
 * 
 * Instructions:
 * 1. Create a new Cloudflare Worker in your Cloudflare dashboard.
 * 2. Paste this code into the Worker editor.
 * 3. Create a D1 database in Cloudflare (e.g. named "brewmaster-db").
 * 4. Go to your Worker's Settings -> Variables -> D1 Database Bindings.
 * 5. Bind your D1 database to the Variable Name "DB".
 * 6. Deploy the Worker and copy the URL (e.g. https://your-worker.workers.dev).
 */
