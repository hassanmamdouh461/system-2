...
export default function Login() {
  ...
  return (
    <>
      {/* ── 3-D coffee-icon keyframes ─────────────────────────────────────── */}
      <style>{`
        @keyframes coffee3d {
          0%   { transform: perspective(400px) rotateY(0deg)   translateY(0px);   }
          25%  { transform: perspective(400px) rotateY(90deg)  translateY(-6px);  }
          50%  { transform: perspective(400px) rotateY(180deg) translateY(0px);   }
          75%  { transform: perspective(400px) rotateY(270deg) translateY(-6px);  }
          100% { transform: perspective(400px) rotateY(360deg) translateY(0px);   }
        }
        .icon-3d {
          animation: coffee3d 4s ease-in-out infinite;
          transform-style: preserve-3d;
          will-change: transform;
        }
        /* Custom checkbox styling to match dark theme */
        .cb-caramel {
          appearance: none;
          -webkit-appearance: none;
          width: 1rem;
        ...
        >
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <div className="relative mb-4">
              <div className="absolute inset-0 rounded-full bg-caramel/40 blur-xl scale-150" />
              <div className="relative bg-gradient-to-br from-caramel to-mocha-600 p-3 rounded-full shadow-lg shadow-caramel/40 icon-3d">
                <Coffee className="w-8 h-8 text-white" />
              </div>
            </div>
            <h1 className="text-3xl font-bold text-white mb-2 tracking-tight">Welcome Back</h1>
